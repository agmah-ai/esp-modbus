...
#define MB_RTU_SER_PDU_SIZE_MAX     MB_SERIAL_BUF_SIZE      /*!< Maximum size of a Modbus RTU frame. */
...
mb_err_enum_t mbs_rtu_transp_create(mb_serial_opts_t *ser_opts, mb_trans_base_t **out_inst);
