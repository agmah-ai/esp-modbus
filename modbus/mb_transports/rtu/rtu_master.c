...
mb_err_enum_t mbm_rtu_transp_create(mb_serial_opts_t *ser_opts, mb_trans_base_t **out_inst);
...
mb_err_enum_t mbm_rtu_transp_create(mb_serial_opts_t *ser_opts, mb_trans_base_t **out_inst)
{
    ...
    transp->port_obj = port_obj; // The copy of the pointer to object
...
// static uint16_t mbm_rtu_get_snd_len(mb_trans_base_t *inst)
// {
//     mbm_rtu_transp_t *transp = __containerof(inst, mbm_rtu_transp_t, base);
