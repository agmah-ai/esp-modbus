...
static bool mbm_ascii_transp_tmr_1s_expired(void *inst);
static bool mbm_ascii_transp_rq_is_bcast(mb_trans_base_t *inst);

mb_err_enum_t mbm_ascii_transp_create(mb_serial_opts_t *ser_opts, mb_trans_base_t **out_inst)
{
    ...
    port_obj->cb.tmr_expired = mbm_ascii_transp_tmr_1s_expired;
