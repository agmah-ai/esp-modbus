...
/* ----------------------- Function prototypes ------------------------------*/
// mb_err_enum_t mbs_tcp_transp_create(mb_tcp_opts_t *tcp_opts, mb_trans_base_t **out_inst)
static void mbs_tcp_transp_start(mb_trans_base_t *inst);
static void mbs_tcp_transp_stop(mb_trans_base_t *inst);
static mb_err_enum_t mbs_tcp_transp_receive(mb_trans_base_t *inst, uint8_t *rcv_addr, uint8_t **frame_ptr_buf, uint16_t *len_buf);
