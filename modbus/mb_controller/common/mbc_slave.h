...
typedef struct _port_serial_opts mb_slave_comm_info_t;
...
typedef esp_err_t (*iface_set_descriptor_fp)(void *, mb_register_area_descriptor_t); /*!< Interface method set_descriptor */
...
typedef struct
{
    ...
    iface_set_descriptor_fp set_descriptor;     /*!< Interface method set_descriptor */
