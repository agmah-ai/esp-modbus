...
def test_modbus_communication(env, comm_mode):
    ...
    dut_master = env.get_dut('modbus_master', os.path.join(curr_path, 'mb_master'), dut_class=ttfw_idf.ESP32DUT)
    dut_slave = env.get_dut('modbus_slave', os.path.join(curr_path, 'mb_slave'), dut_class=ttfw_idf.ESP32DUT)
