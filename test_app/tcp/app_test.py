...
def test_modbus_communication(env, comm_mode):
    ...
    dut_master = env.get_dut('modbus_tcp_master', os.path.join(curr_path, TEST_MASTER_TCP))
    dut_slave = env.get_dut('modbus_tcp_slave', os.path.join(curr_path, TEST_SLAVE_TCP))
