...
static esp_err_t init_services(void)
{
    ...
    MB_SLAVE_CHECK((result == ESP_OK), ESP_ERR_INVALID_STATE,
...
static esp_err_t destroy_services(void)
{
    ...
    MB_SLAVE_CHECK((err == ESP_OK), ESP_ERR_INVALID_STATE,
    ...
    MB_SLAVE_CHECK((err == ESP_OK || err == ESP_ERR_NOT_SUPPORTED), ESP_ERR_INVALID_STATE,
...
static esp_err_t slave_init(mb_communication_info_t* comm_info)
{
    ...
    MB_SLAVE_CHECK((err == ESP_OK && slave_handler != NULL), ESP_ERR_INVALID_STATE,
